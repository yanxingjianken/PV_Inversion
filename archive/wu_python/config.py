...
# (384 cores available on this machine; 64 is recommended)
N_WORKERS: int = 32

# Number of cores for numba parallel (thread-level, within-process)
# Set to 0 for auto-detect, or N for explicit core count
NUM_CORES: int = 64  # use 64 threads for numba prange
...
OMEGS: float = 1.75       # SOR relaxation factor for ψ  (matches Fortran omegs=1.75)
OMEGH: float = 1.75       # SOR relaxation factor for Φ  (matches Fortran omegah=1.75)
