...
\begin{longtable}{lll}
  ...
  $g$                  & m/s$^2$      & gravity (Fortran $9.81$) \\
  $J(a,b)$             & varies       & Jacobian \\
  $\kappa=R_d/c_p$     & --           & $2/7\approx 0.2857$ (Wu hardcoded) \\
  $\Lap,\;\Lapinv$     & m$^{-2}$     & horizontal Laplacian and its inverse \\
  $\theta_b$           & K            & boundary potential temperature (surface/top) \\
